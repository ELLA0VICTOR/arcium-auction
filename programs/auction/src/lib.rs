...
declare_id!("5gnKVawJTz7aFEJWxEDgCANUZbpmKzm9U9FnXbuYWdkr");
...
pub mod auction {
    ...
    pub fn init_auction_state_comp_def(ctx: Context<InitAuctionStateCompDef>) -> Result<()> {
        init_comp_def(
            ...
            Some(CircuitSource::OffChain(OffChainCircuitSource {
                source: "https://zxfradkkhbepggmffgav.supabase.co/storage/v1/object/public/arcium-circuits/init_auction_state.arcis"
                    .to_string(),
    ...
    pub fn init_place_bid_comp_def(ctx: Context<InitPlaceBidCompDef>) -> Result<()> {
        init_comp_def(
            ctx.accounts,
            Some(CircuitSource::OffChain(OffChainCircuitSource {
                source: "https://zxfradkkhbepggmffgav.supabase.co/storage/v1/object/public/arcium-circuits/place_bid.arcis"
                    .to_string(),
    ...
    pub fn init_determine_winner_first_price_comp_def(
        ...
        init_comp_def(
            ctx.accounts,
            Some(CircuitSource::OffChain(OffChainCircuitSource {
                source: "https://zxfradkkhbepggmffgav.supabase.co/storage/v1/object/public/arcium-circuits/determine_winner_first_price.arcis"
                    .to_string(),
    ...
    pub fn init_determine_winner_vickrey_comp_def(
        ...
        init_comp_def(
            ctx.accounts,
            Some(CircuitSource::OffChain(OffChainCircuitSource {
                source: "https://zxfradkkhbepggmffgav.supabase.co/storage/v1/object/public/arcium-circuits/determine_winner_vickrey.arcis"
                    .to_string(),
